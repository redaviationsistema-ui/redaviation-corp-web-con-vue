...
export const paginasNuevas = [
  {
    ...
    visual: {
      ...
      imagen: '/imagenes/gesa-componentes.png',
    ...
    galeria: [
      { fuente: '/imagenes/gesa-componentes.png', alt: 'Trabajo técnico con componentes aeronáuticos' },
      { fuente: '/imagenes/gesa-avionica.png', alt: 'Inspección de aviónica en laboratorio' },
      { fuente: '/imagenes/gesa-taller.png', alt: 'Equipo técnico de GESA en taller' },
      { fuente: '/imagenes/IMG_7929.jpg', alt: 'Integración operativa y soporte técnico en GESA' },
      { fuente: '/imagenes/IngeAvionica.png', alt: 'Ingeniería de aviónica en instalaciones de GESA' },
      { fuente: '/imagenes/IngeAvionica1.png', alt: 'Trabajo técnico de aviónica y componentes en GESA' },
      { fuente: '/imagenes/Prototipos1.jpg', alt: 'Prototipos y desarrollo técnico aplicado en GESA' },
    ],
    bloques: [
  ...
  },
  {
    ...
    visual: {
      ...
      imagen: '/imagenes/excel-motor.png',
    ...
    galeria: [
      { fuente: '/imagenes/IMG_7684.jpg', alt: 'Inspección técnica de motor en Excel Turbines' },
      { fuente: '/imagenes/IMG_7685.jpg', alt: 'Mantenimiento especializado de turbinas en Excel Turbines' },
      { fuente: '/imagenes/EXCEL.jpg', alt: 'Capacidad técnica en taller de Excel Turbines' },
      { fuente: '/imagenes/EXCELL.jpg', alt: 'Soporte técnico y ejecución en Excel Turbines' },
    ],
    bloques: [
  ...
  },
  {
    ...
    galeria: [
      { fuente: '/imagenes/cesa-aeronave.png', alt: 'Aeronave dentro de instalaciones de mantenimiento' },
      { fuente: '/imagenes/cesa-inspeccion.png', alt: 'Inspección técnica de una aeronave' },
      { fuente: '/imagenes/cesa-motor.png', alt: 'Técnico inspeccionando sistemas de una aeronave' },
    ],
    bloques: [
  ...
  },
  {
    ...
    imagenDebajoHero: {
      src: '/imagenes/FotoJoseLuisG500.png',
      alt: 'José Luis junto a un Gulfstream G500 en Sky Group',
    },
    visual: {
      etiqueta: 'Sky Group',
      tipo: 'Consultoría estratégica',
      imagen: '/imagenes/sky-group-consultoria.jpg',
      alt: 'Reunión de consultoría estratégica de Sky Group',
    },
    logoTitulo: {
      src: '/imagenes/logo-skygroup.png',
      alt: 'Logo de Sky Group',
    },
    galeria: [
      { fuente: '/imagenes/FotoJoseLuisG500.png', alt: 'José Luis junto a un Gulfstream G500 en Sky Group' },
      { fuente: '/imagenes/hangar-operacion.png', alt: 'Operación de aeronave de Red Aviation' },
      { fuente: '/imagenes/hangar-plataforma.png', alt: 'Aeronave y equipo de apoyo en plataforma' },
    ],
    bloques: [
...
const contenidoServiciosEspeciales = {
  'taller-motores': {
    ...
    multimedia: {
      ...
      portada: '/imagenes/tallermotores.png',
  ...
  'taxi-aereo': {
    ...
    multimediaDestacada: {
      ...
      video: {
        tipo: 'youtube',
        fuente:
          'https://www.youtube.com/embed/IGHBEWp0-fc?autoplay=1&mute=1&loop=1&playlist=IGHBEWp0-fc&controls=0&playsinline=1&rel=0',
        enlace: 'https://youtube.com/shorts/IGHBEWp0-fc',
...
export const carruselEmpresas = [
  ...
  },
  {
    ...
    ruta: '/excel-turbines',
    imagen: '/imagenes/logo-excel.png',
  ...
  },
  {
    ...
    ctaTexto: 'Conoce mas',
    ruta: '/sky-group',
    imagen: '/imagenes/logo-skygroup.png',
...
export const carruselMultimedia = [
  ...
  },
  {
    ...
    imagen: '/imagenes/tallerdeavionica-infraestructura2.jpg',
  ...
  },
  {
    ...
    imagen: '/imagenes/PArteHeliInfraestructura1.jpg',
  ...
  },
  {
    ...
    imagen: '/imagenes/talleroverhaul-helicoptero-infraestructura3.jpg',
  ...
  },
  {
    ...
    imagen: '/imagenes/IMG_7987-2.png',
  ...
  },
  {
    ...
    imagen: '/imagenes/proyectos-inicio.png',
