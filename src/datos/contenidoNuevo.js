...
export const paginasNuevas = [
  {
    ...
    visual: {
      ...
      imagen: '/imagenes/gesa-componentes.png?v=1',
    ...
    galeria: [
      { fuente: '/imagenes/gesa-componentes.png?v=1', alt: 'Trabajo técnico con componentes aeronáuticos' },
      { fuente: '/imagenes/gesa-avionica.png?v=1', alt: 'Inspección de aviónica en laboratorio' },
      { fuente: '/imagenes/gesa-taller.png?v=1', alt: 'Equipo técnico de GESA en taller' },
      { fuente: '/imagenes/IMG_7929.jpg?v=1', alt: 'Integración operativa y soporte técnico en GESA' },
      { fuente: '/imagenes/IngeAvionica.png?v=1', alt: 'Ingeniería de aviónica en instalaciones de GESA' },
      { fuente: '/imagenes/IngeAvionica1.png?v=1', alt: 'Trabajo técnico de aviónica y componentes en GESA' },
      { fuente: '/imagenes/Prototipos1.jpg?v=1', alt: 'Prototipos y desarrollo técnico aplicado en GESA' },
    ],
    bloques: [
  ...
  },
  {
    ...
    visual: {
      ...
      imagen: '/imagenes/excel-motor.png?v=1',
    ...
    galeriaUniforme: true,
    galeria: [
      { fuente: '/imagenes/IMG_7684.jpg?v=1', alt: 'Inspección técnica de motor en Excel Turbines' },
      { fuente: '/imagenes/IMG_7685.jpg?v=1', alt: 'Mantenimiento especializado de turbinas en Excel Turbines' },
      { fuente: '/imagenes/EXCEL.jpg?v=1', alt: 'Capacidad técnica en taller de Excel Turbines' },
      { fuente: '/imagenes/EXCELL.jpg?v=1', alt: 'Soporte técnico y ejecución en Excel Turbines' },
    ],
    bloques: [
  ...
  },
  {
    ...
    visual: {
      ...
      alt: 'Interiores y trabajo técnico especializado en CESA',
    },
    logoTitulo: {
    ...
    galeria: [
      { fuente: '/imagenes/cesa-aeronave.png?v=1', alt: 'Aeronave dentro de instalaciones de mantenimiento' },
      { fuente: '/imagenes/cesa-inspeccion.png?v=1', alt: 'Inspección técnica de una aeronave' },
      { fuente: '/imagenes/cesa-motor.png?v=1', alt: 'Técnico inspeccionando sistemas de una aeronave' },
    ],
    bloques: [
  ...
  },
  {
    ...
    imagenDebajoHero: {
      src: '/imagenes/FotoJoseLuisG500.png?v=1',
      alt: 'José Luis junto a un Gulfstream G500 en Sky Group',
    },
    visual: {
      etiqueta: 'Sky Group',
      tipo: 'Consultoría estratégica',
      imagen: '/imagenes/sky-group-consultoria.jpg?v=1',
      alt: 'Reunión de consultoría estratégica de Sky Group',
    },
    logoTitulo: {
      src: '/imagenes/logo-skygroup.png?v=1',
      alt: 'Logo de Sky Group',
    },
    galeria: [
      { fuente: '/imagenes/FotoJoseLuisG500.png?v=1', alt: 'José Luis junto a un Gulfstream G500 en Sky Group' },
      { fuente: '/imagenes/hangar-operacion.png?v=1', alt: 'Operación de aeronave de Red Aviation' },
      { fuente: '/imagenes/hangar-plataforma.png?v=1', alt: 'Aeronave y equipo de apoyo en plataforma' },
    ],
    bloques: [
...
const contenidoServiciosEspeciales = {
  'taller-motores': {
    ...
    multimedia: {
      tipo: 'video',
      fuente: '/videos/c0445.mp4',
      portada: '/imagenes/tallermotores.png?v=1',
  ...
  'mantenimiento-militar': {
    ...
    galeria: [
      {
        fuente: '/imagenes/Militar1.png?v=1',
      ...
      {
        fuente: '/imagenes/Militar2.png?v=1',
      ...
      {
        fuente: '/imagenes/Militar3.png?v=1',
...
export const carruselEmpresas = [
  {
    ...
    ruta: '/gesa',
    imagen: '/imagenes/logo-gesa.png?v=1',
  ...
  },
  {
    ...
    ruta: '/cesa',
    imagen: '/imagenes/logo-cesa.png?v=1',
  ...
  },
  {
    ...
    ruta: '/excel-turbines',
    imagen: '/imagenes/logo-excel.png?v=1',
  ...
  },
  {
    ...
    ctaTexto: 'Conoce mas',
    ruta: '/sky-group',
    imagen: '/imagenes/logo-skygroup.png?v=1',
...
export const carruselMultimedia = [
  {
    ...
    imagen: '/imagenes/hangar2.png?v=1',
    alt: 'Aeronaves ejecutivas dentro de un hangar de mantenimiento',
  },
  {
    etiqueta: 'Infraestructura',
    titulo: 'Capacidad instalada',
    descripcion: 'Espacios operativos, resguardo técnico y áreas de trabajo listas para respaldar operaciones aeronáuticas de alto nivel.',
    imagen: '/imagenes/IMG_7700.jpg?v=1',
    alt: 'Infraestructura aeronáutica y hangar operativo de Red Aviation',
  },
  {
    etiqueta: 'Aviónica',
    titulo: 'Taller especializado de aviónica',
    descripcion: 'Área técnica orientada a diagnóstico, integración de sistemas, componentes y soporte especializado para aeronaves.',
    imagen: '/imagenes/tallerdeavionica-infraestructura2.jpg?v=1',
    alt: 'Taller especializado de aviónica dentro de la infraestructura de Red Aviation',
  },
  {
    etiqueta: 'Helicópteros',
    titulo: 'Partes y soporte para helicópteros',
    descripcion: 'Capacidad visual y operativa para respaldar mantenimiento, revisión y atención técnica en componentes especializados.',
    imagen: '/imagenes/PArteHeliInfraestructura1.jpg?v=1',
    alt: 'Partes y soporte técnico para helicópteros en instalaciones de Red Aviation',
  },
  {
    etiqueta: 'Overhaul',
    titulo: 'Taller de overhaul para helicópteros',
    descripcion: 'Infraestructura para trabajos de mayor alcance, intervención técnica profunda y continuidad operativa especializada.',
    imagen: '/imagenes/talleroverhaul-helicoptero-infraestructura3.jpg?v=1',
    alt: 'Taller de overhaul para helicópteros en infraestructura de Red Aviation',
  },
  {
    etiqueta: 'Instalaciones',
    titulo: 'Espacios de trabajo y soporte operativo',
    descripcion: 'Áreas de operación, equipamiento e infraestructura complementaria que fortalecen la ejecución técnica y documental.',
    imagen: '/imagenes/IMG_7987-2.png?v=1',
    alt: 'Espacios de trabajo e infraestructura operativa de Red Aviation',
  },
  {
    etiqueta: 'Operaciones',
    titulo: 'Proyectos en Curso',
    descripcion: 'Intervenciones, inspecciones y procesos coordinados por equipos especializados.',
    imagen: '/imagenes/proyectos-inicio.png?v=1',
